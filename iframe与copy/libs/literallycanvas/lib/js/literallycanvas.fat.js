...
(function() {
	...
	initLiterallyCanvas = function(el, opts) {
		...
		opts = _.extend({
			...
			imageURLPrefix: "libs/literallycanvas/lib/img",
			keyboardShortcuts: true,
			sizeToContainer: true,
			toolClasses: [LC.Pencil, LC.pointSB, LC.RectangleTool, LC.Eraser, LC.Pan, LC.EyeDropper]
		}, opts);
		$el = $(el);
...
(function() {
	...
	LC.pointSB = function(_super) {
		__extends(pointSB, _super);

		function pointSB() {
			return pointSB.__super__.constructor.apply(this, arguments);
		}
		pointSB.prototype.title = "pointSB";
		pointSB.prototype.cssSuffix = "eye-pointSB";
		pointSB.prototype.buttonContents = function() {
			return "<span class='icon-hand-up'></span> 箭头";
		};
		pointSB.prototype.readColor = function(x, y, lc) {

		};
		pointSB.prototype.begin = function(x, y, lc) {
			return this.readColor(x, y, lc);
		};
		pointSB.prototype["continue"] = function(x, y, lc) {
			return this.readColor(x, y, lc);
		};
		return pointSB;
	}(LC.Tool);
