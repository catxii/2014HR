...
Cute.ModuleLoader.css3d_files = ["" + CSSettings.pluginJsPath + "/cute.css3d.module.js"];
Cute.ModuleLoader.canvas_files = ["" + CSSettings.pluginJsPath + "/cute.canvas.module.js"];
Cute.ModuleLoader.dom2d_files = ["" + CSSettings.pluginJsPath + "/cute.2d.module.js"];
...
Averta.EventDispatcher.prototype = {
	...
	removeEventListener: function(e, t, n) {
		if (this.listener[e.type]) {
			for (var r = 0, i = this.listeners[e].length; r < i; ++r) if (t == this.listeners[e][r].listener && n == this.listeners[e][r].ref) this.listeners[e].splice(r);
			if (this.listeners[e].length == 0) delete this.listeners[e]
		}
	},
	dispatchEvent: function(e) {
		e.target = this;
		if (this.listeners[e.type]) for (var t = 0, n = this.listeners[e.type].length; t < n; ++t) {
