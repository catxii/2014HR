        ...
        tablePaging: function (options) {
            ...
            $(this).each(function () {
                ...
                if (allPage > 1) {
                    ...
                    jQuery("#" + jQuery(this).attr('id')).after('<div id="' + jQuery(this).attr('id') + 'Paging" class="text-center"></div>');
                    queue = '#' + jQuery(this).attr('id') + 'Paging';
                    jQuery(queue).append('<ul class="paging pagination center"><li id="prePage" tableid="' + jQuery(this).attr('id') + '" pageindex=' + (parseInt(jQuery(this).data("pageindex")) - 1) + '><a href="javascript:void(0)">上一页</a></li><li><a href="javascript:void(0)">'+ (parseInt(jQuery(this).data("pageindex")) + 1) + '/' + allPage + '</a><li> <li  id="nextPage" tableid="' + jQuery(this).attr('id') + '" pageindex=' + (parseInt(jQuery(this).data("pageindex")) + 1) + ' ><a href="javascript:void(0)">下一页</a></li></ul>');
